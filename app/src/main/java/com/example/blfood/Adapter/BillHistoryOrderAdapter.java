...
public class BillHistoryOrderAdapter extends RecyclerView.Adapter<BillHistoryOrderAdapter.ViewHolder> {
    Context context;
    List<ItemCart> itemCartList;

    public BillHistoryOrderAdapter(Context context, List<ItemCart> itemCartList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new BillHistoryOrderAdapter.ViewHolder(view);
    }
